...
fun ForgotPasswordScreen(){
    Box(modifier = Modifier.fillMaxSize()
        ...
        Column(
            ...
            HeadingTextComponent(value = stringResource(id = R.string.forgot_password_heading))
            Image(
    ...
    FirebaseAuth
        ...
        .addOnCompleteListener { task ->
            if (task.isSuccessful) {
                Toast.makeText(context, "Link sent. Please check your email inbox and try to login again.", Toast.LENGTH_SHORT).show()
                GoProAppRoute.navigateTo(Screen.WelcomeScreen)
            }
        }
        .addOnFailureListener {
            Toast.makeText(context, "Error. Please check your info and try again.", Toast.LENGTH_SHORT).show()
        }
}
