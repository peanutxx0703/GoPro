...
@Composable
fun TeacherTermsAndConditionsScreen(){
    Box(modifier = Modifier.fillMaxSize()
        ...
        Column(
            ...
            NormalTextComponent(value = stringResource(id = R.string.tncs_1))

            Spacer(modifier = Modifier.height(20.dp))
            NormalTextComponent(value = stringResource(id = R.string.tncs_2))
...
@Preview
@Composable
fun TeacherTermsAndConditionsScreenPreview(){
    TeacherTermsAndConditionsScreen()
}