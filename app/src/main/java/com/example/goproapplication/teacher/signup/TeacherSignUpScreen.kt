package com.example.goproapplication.teacher.signup
...
@Composable
fun TeacherSignUpScreen(signUpViewModel: SignUpViewModel = viewModel()){
    ...
    Box(modifier = Modifier.fillMaxSize()
        ...
        Column(
            ...
            HeadingTextComponent(value = stringResource(id = R.string.teacher_sign_up_text))
