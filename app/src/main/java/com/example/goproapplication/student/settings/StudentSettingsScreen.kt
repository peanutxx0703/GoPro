...
@Composable
fun StudentSettingsScreen(studentLoginViewModel: StudentLoginViewModel){
    ...
    Box(modifier = Modifier.fillMaxSize()
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                IconButton(
                    onClick = { GoProAppRoute.navigateTo(Screen.StudentProfileScreen) }
                ) {
                    Icon(
            ...
            CardItemComponent(
                ...
                onClick = { GoProAppRoute.navigateTo(Screen.StudentChangePasswordScreen)}
            )
            ...
            CardItemComponent(
                ...
                onClick = { GoProAppRoute.navigateTo(Screen.StudentContactUsScreen) }
            )
            CardItemComponent(
                painterResource = painterResource(id = R.drawable.privacy_policy),
                value = stringResource(id = R.string.privacy_policy),
                onClick = { GoProAppRoute.navigateTo(Screen.StudentPrivacyPolicyScreen) }
            )
            CardItemComponent(
                painterResource = painterResource(id = R.drawable.terms_and_conditions),
                value = stringResource(id = R.string.terms_and_conditions),
                onClick = { GoProAppRoute.navigateTo(Screen.StudentTermsAndConditionsScreen) }
            )
            ButtonComponent(
                value = stringResource(id = R.string.log_out),
                onButtonClicked = { studentLoginViewModel.logout(context) },
                isEnabled = true
            )
        }
    }
...
fun StudentSettingsScreenPreview(){
    StudentSettingsScreen(StudentLoginViewModel())
}